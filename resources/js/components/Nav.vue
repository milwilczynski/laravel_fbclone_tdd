<template>
    <div
        class="bg-white h-12 p-4 flex items-center border-b border-gray-300 shadow-sm"
    >
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
                ...
                <div class="ml-2 relative">
                    ...
                    <input
                        ...
                        placeholder="Szukaj w facebooku"
                    />
                </div>
            </div>
        </div>

        <div class="w-1/3 flex justify-center items-center h-12">
            <router-link
                to="/"
                class="px-6 border-b-2 border-blue-500 flex items-center h-full"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
            ...
            <router-link
                ...
                class="px-6 border-b-2 border-white flex items-center h-full"
            >
                <img
                    :src="
